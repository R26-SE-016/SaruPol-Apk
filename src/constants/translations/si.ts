export default {
  ...
  yield: {
    dashboard: "ගොවිපල පුවරුව",
    telemetry: "ටෙලිමෙට්‍රි",
    logs: "වාර්තා",
    analytics: "විශ්ලේෂණ",
    liveEnv: "සජීවී පරිසරය",
    realtimeIot: "තත්‍ය කාලීන IoT",
    weatherApi: "කාලගුණ API",
    ...
    weather: "කාලගුණය",
    marketIntel: "වෙළඳපොළ තොරතුරු",
    fieldCare: "ක්ෂේත්‍ර සත්කාර නිර්දේශ",
    zones: "ගොවිපල කලාප",
    noZones: "තවමත් කලාප අර්ථ දක්වා නැත.",
